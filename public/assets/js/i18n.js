...
(function () {
  ...
  var DICT = {
    uk: {
      ...
      "cert.successCodeLabel": "Номер вашого сертифіката",
      "cert.successCodeHint": "Збережіть цей номер — назвіть його адміністратору, коли прийдете в студію",
    ...
    en: {
      ...
      "cert.successCodeLabel": "Your certificate number",
      "cert.successCodeHint": "Save this number — tell it to our staff when you visit the studio",
