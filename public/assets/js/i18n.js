...
(function () {
  ...
  var DICT = {
    uk: {
      ...
      "cert.successShareCta": "Відкрити Instagram Oliva ↗",
      ...
      "book.step2.title": "Послуги", "book.step2.sub": "Оберіть послугу",
      "book.search.placeholder": "Пошук масажу за назвою…", "book.search.aria": "Пошук послуги за назвою",
      "book.showmore": "Показати ще",
      "book.step3.title": "Оберіть майстра", "book.step3.sub": "Для вашої послуги",
      "book.pairhint": "👥 Це парна процедура — оберіть майстра для себе, другого майстра для партнера підбере студія автоматично.",
      "book.step4.title": "Тривалість сеансу", "book.step4.sub": "Оберіть зручний час",
      "book.help.title": "Не знаєте, що обрати?", "book.help.desc": "Напишіть нам у Telegram — адміністратори допоможуть підібрати ідеальний сеанс для вас",
      "book.extras.title": "Додаткові послуги", "book.extras.sub": "Доповніть сеанс за бажанням",
      "book.extras.recommend": "Рекомендуємо", "book.extras.total": "Разом", "book.extras.continue": "Зберегти та продовжити",
      "book.step5.title": "Дата та час", "book.step5.sub": "Оберіть зручний час",
      "book.othermasters": "Показати час інших майстрів",
      "book.freetime.note": "Вільний час може змінюватись. Будь ласка, оберіть актуальний слот",
      "book.back": "← Назад",
      "book.step6.title": "Ваш запис", "book.step6.sub": "Перевірте деталі запису",
      "book.nameLabel": "Ваше ім'я", "book.namePh": "Ваше ім'я", "book.phoneLabel": "Телефон",
      "book.addService.title": "Додати послугу", "book.addService.hint": "Забули щось? Додайте без повернення на початок",
      "book.addWish.title": "Додати побажання", "book.addWish.hint": "Покращіть свій сеанс релаксу",
      "book.commentLabel": "Коментар", "book.commentPh": "Побажання…",
      "book.confirm": "Підтвердити запис", "book.secure": "Ваші дані надійно захищені",
      "book.done.title": "Запис прийнято!",
      "book.tg.title": "Отримати повідомлення після візиту",
      "book.tg.copy": "Підключіть Telegram один раз — після завершення масажу ми надішлемо персональне посилання для відгуку.",
      "book.tg.button": "Підключити Telegram",
      "book.tg.reconnect": "Перепідключити Telegram",
      "book.tg.connected": "✓ Telegram уже підключено. Повідомлення прийде сюди після завершення візиту.",
      "book.cal.title": "Додати нагадування в календар", "book.cal.google": "Google Календар", "book.cal.apple": "Apple / iOS",
      "book.help2.title": "Потрібна допомога?", "book.help2.write": "Написати:",
      ...
      "book.trust.online1": "Онлайн-запис", "book.trust.online2": "24/7",
      "book.trust.secure1": "Захищене", "book.trust.secure2": "з'єднання"
    },
    ...
    en: {
      ...
      "cert.successShareCta": "Open Oliva on Instagram ↗",
      ...
      "book.step2.title": "Services", "book.step2.sub": "Choose a service",
      "book.search.placeholder": "Search massage by name…", "book.search.aria": "Search service by name",
      "book.showmore": "Show more",
      "book.step3.title": "Choose a therapist", "book.step3.sub": "For your service",
      "book.pairhint": "👥 This is a couples treatment — choose a therapist for yourself, the studio will assign the second therapist for your partner automatically.",
      "book.step4.title": "Session duration", "book.step4.sub": "Choose a convenient time",
      "book.help.title": "Not sure what to choose?", "book.help.desc": "Message us on Telegram — our staff will help you pick the perfect session",
      "book.extras.title": "Add-on services", "book.extras.sub": "Enhance your session if you'd like",
      "book.extras.recommend": "Recommended", "book.extras.total": "Total", "book.extras.continue": "Save and continue",
      "book.step5.title": "Date & Time", "book.step5.sub": "Choose a convenient time",
      "book.othermasters": "Show other therapists' times",
      "book.freetime.note": "Available times may change. Please choose a current slot",
      "book.back": "← Back",
      "book.step6.title": "Your Booking", "book.step6.sub": "Review your booking details",
      "book.nameLabel": "Your name", "book.namePh": "Your name", "book.phoneLabel": "Phone",
      "book.addService.title": "Add a service", "book.addService.hint": "Forgot something? Add it without starting over",
      "book.addWish.title": "Add a request", "book.addWish.hint": "Enhance your relaxation session",
      "book.commentLabel": "Comment", "book.commentPh": "Special requests…",
      "book.confirm": "Confirm booking", "book.secure": "Your data is securely protected",
      "book.done.title": "Booking confirmed!",
      "book.tg.title": "Get a message after your visit",
      "book.tg.copy": "Connect Telegram once and we will send your personal review link after the massage.",
      "book.tg.button": "Connect Telegram",
      "book.tg.reconnect": "Reconnect Telegram",
      "book.tg.connected": "✓ Telegram is already connected. You will receive the message after your visit.",
      "book.cal.title": "Add a calendar reminder", "book.cal.google": "Google Calendar", "book.cal.apple": "Apple / iOS",
      "book.help2.title": "Need help?", "book.help2.write": "Message us:",
      "book.rules.title": "Правила відвідування", "book.contra.title": "Абсолютні протипокази",
      ...
      "book.trust.online1": "Online booking", "book.trust.online2": "24/7",
      "book.trust.secure1": "Secure", "book.trust.secure2": "connection"
    }
  };
  ...
  var SRV_PHRASES = [
    ...
    ['Лімфоденажний масаж тіла',                     'Lymphatic drainage body massage'],
    ['Вогняний масаж бамбуковими банками',           'Fire massage with bamboo cups'],
    ...
    ['Масаж гарячим камінням для двох',              'Hot stone massage for two'],
    ['Масаж гарячим камінням',                       'Hot stone massage'],
    ['Апаратно-вакуумний масаж',                     'Apparatus vacuum massage'],
    ['Масаж голови',                                 'Head massage'],
    ['Масаж долонь',                                 'Hand massage'],
    ['Масаж зі зволожувальним кремом',               'Massage with moisturizing cream'],
    ...
    ['Фіто-оновлення тіла для двох',                 'Phyto body renewal for two'],
    ['Фото -оновлення для двох',                     'Phyto renewal for two'],
    ['Глибоке прогрівання у ІЧ Сауні',               'Deep warming in IR sauna'],
    ['Гаряче каміння',                               'Hot stones'],
    ['Композиція зі свічок',                         'Candle composition'],
    ['Душ',                                          'Shower'],
