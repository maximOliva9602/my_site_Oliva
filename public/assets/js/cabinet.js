...
(function () {
  ...
  // Знижка на абонемент залежно від к-ті сеансів: 5 → 5%, 10 → 10%, 15 → 15%
  // (та сама схема, що на сторінках послуг — "-5%/-10%/-15%" у блоці Абонементи).
  ...
  function apptModal(opts) {
    ...
    // кількості сеансів і знижки (5 → 5%, 10 → 10%, 15 → 15%).
